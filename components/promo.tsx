...
//   return (
//     <>
//       <div className=" lg:h-[calc(100vh-250px)] p-4 bg-white flex items-center justify-center max-sm:mt-10">
...
const Promo = () => {
  ...
  // ✅ Initialize timer only after mount
  const targetDate = useMemo(() => {
    const d = new Date();
    d.setDate(d.getDate() + DAYS_TO_RUN);
    return d;
  ...
  if (!mounted)
    return (
      <div className="lg:h-[calc(100vh-250px)] p-4 bg-white flex items-center justify-center">
